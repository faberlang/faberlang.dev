...
Blind trial: translate fresh from English only. Target locale: Simplified Chinese (zh-Hans).
...
Translate heading *text* into Simplified Chinese; keep {#anchors} in English slug form exactly as given.
Keep Latin Faber tokens in backticks and Source table cells; translate explanation columns only.
