...
ดาวน์โหลดรุ่นปัจจุบัน (**1.6.0**) สำหรับแพลตฟอร์มของคุณจาก[หน้าติดตั้ง](/start/install.html) ตรวจสอบ checksum ของไฟล์เก็บถาวร แล้วนำ `bin/faber` จากโฟลเดอร์ `bin/` และ `share/` ของไฟล์เก็บถาวรไปไว้ใน `PATH` ของคุณ (เก็บโฟลเดอร์ทั้งสองไว้ด้วยกันเพื่อให้ reader pack แก้ไขได้) ยืนยันด้วยคำสั่ง:
...
ดูแพ็กเกจเหล่านี้ได้ที่[หน้าตัวอย่าง](/examples/)
...
|---|---|---|
| 1 | [ติดตั้งและดาวน์โหลด](/start/install.html) | วาง Faber 1.6.0 ไว้ใน `PATH` และตรวจสอบการติดตั้ง |
