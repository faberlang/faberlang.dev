...
หน้านี้อ้างอิงอาร์ทิแฟกต์รุ่นรีลีสของ repository สำหรับ Faber 1.6.0 สูตรของตัวจัดการแพ็กเกจอาจเผยแพร่ตามหลังรีลีสของ repository หาก Homebrew หรือตัวจัดการแพ็กเกจอื่นรายงานเวอร์ชัน Radix/Faber ที่เก่ากว่า ให้ใช้ไฟล์เก็บถาวรด้านล่างสำหรับเส้นทางนี้
...
| **คอมไพเลอร์ในตัว** | Radix 0.81.0 |
| **หน้ารีลีส** | [faber-v1.6.0 บน GitHub](https://github.com/faberlang/releases/releases/tag/faber-v1.6.0) |
...
ไฟล์เก็บถาวรประกอบด้วยโฟลเดอร์ `bin/` และ `share/` ติดตั้งทั้งสองอย่างเพื่อให้ reader pack แก้ไขข้างไบนารีได้ (ไฟล์ checksum อาจระบุพาธการสร้างเดิม ดังนั้นให้ตรวจสอบโดยเปรียบเทียบฟิลด์แฮชแรกกับไฟล์เก็บถาวรในเครื่อง แทนการพึ่งพาการจับคู่พาธของ `sha256sum -c`)
