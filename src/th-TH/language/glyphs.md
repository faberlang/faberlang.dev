...
| `≅` `≇` | ความเท่ากันแบบตรงทั้งหมดหลังเลื่อนประเภท — ค่าเดียวกัน ประเภทตัวเลขที่เข้ากันได้ |
| `<` `>` `≤` `≥` | การเรียงลำดับ |
| `≈` `≉` | ความเท่ากันแบบคลาดเคลื่อน — เข้าคู่ภายในค่าคลาดเคลื่อนตามค่าเริ่มต้น `isclose` |
...
| `≅` `≇` | ความเท่ากันแบบตรงทั้งหมดหลังเลื่อนประเภท — รวมความกว้างตัวเลขแล้วเทียบแบบตรงทั้งหมด |
| `≈` `≉` | ความเท่ากันแบบคลาดเคลื่อน — เข้าคู่ภายในค่าคลาดเคลื่อนตามค่าเริ่มต้น `isclose` |
| `<` `>` `≤` `≥` | การเปรียบเทียบลำดับ |
