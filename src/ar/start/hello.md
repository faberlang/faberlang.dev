...
البرنامج أعلاه هو العرض المرجعي باللاتينية. يمكن لعروض القارئ تقديم نفس البرنامج الدلالي بحزم كلمات مفتاحية مختلفة مع الحفاظ على الرموز والمعرّفات. ابدأ بالإثبات الكامل في [لغة القارئ](/language/reader-locales.html) قبل كتابة حزم غير لاتينية.

## التالي {#next}

| السابق | التالي |
|---|---|
| [التثبيت والتحميل](/start/install.html) | [الأوامر التي ستستخدمها](/cheatsheet/commands.html) |
