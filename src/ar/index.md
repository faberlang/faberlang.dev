...
[الإصدارات](/reference/releases.html).
...
انظر [لغة القارئ](/language/reader-locales.html) لنفس البرنامج الدلالي المُصيَّر عبر حزم التايلاندية، والصينية المبسطة، والصينية التقليدية، والعربية، والهندية، والفيتنامية.
...
- **رموز بنيوية** — تدفق القيم ووصلات الأنواع: `←` (ربط)، `→` (نوع الإرجاع)، `∴` (وصلة الإغلاق)، `≡` (تساوي)، `∪` (اتحاد).
...
| القسم | الوصف |
|---|---|
| [التاريخ](/reference/design.html) | الجدول الزمني للتطوير، والتأثيرات، وتاريخ الإصدارات |
| [الإصدارات](/reference/releases.html) | أحدث تحميل لـ Faber بالإضافة إلى كل وسم وثنائي منشور |
| [الميزات](/language/) | لغة القارئ، مسارات التصريف، المفردات اللاتينية، نظام الرموز، مبادئ التصميم |
| [الصياغة](/language/) | مرجع كامل: الأنواع، الدوال، تدفق التحكم، الأخطاء، العموميات، المجموعات |
| [الأدوات](/toolchain/) | خط أنابيب مصرف Radix، واجهة Faber CLI، أهداف توليد الشيفرة، البرمجة النصية |
| [النظام البيئي](/libraries/) | Norma، Cista، Triga، coreutils، AI Workbench، corpus |
| [المدونة](/corpus/) | صفحات كلمات مفتاحية وبنى مُنشأة من المدونة العامة |
| [المراجع](/reference/) | قواعد EBNF، وثائق التصميم، المستودعات |
...
انظر توثيق [لغة القارئ](/language/reader-locales.html) للنقاش الكامل.
