...
source_locale = "en-US"
+++
Tải xuống các gói lưu trữ Faber CLI dựng sẵn và duyệt mọi thẻ đã phát hành trong kho tài sản [faberlang/releases](https://github.com/faberlang/releases). Trang này dành cho **cài đặt** CLI trình biên dịch, không dành cho việc tự dựng trình biên dịch từ mã nguồn.
...
## Bản phát hành mới nhất — Faber 1.1.1 {#latest}
...
| **Phiên bản** | 1.1.1 |
| **Thẻ** | `faber-v1.1.1` |
| **Phát hành** | 2026-07-17 |
| **GitHub** | [faber-v1.1.1](https://github.com/faberlang/releases/releases/tag/faber-v1.1.1) |
| **Giấy phép** | MIT |

### Tệp nhị phân {#latest-binaries}

| Nền tảng | Gói lưu trữ | Kích thước | SHA-256 |
|---|---|---|---|
...
Giải nén gói lưu trữ và đưa tệp nhị phân `faber` vào `PATH`. Xem hướng dẫn từng bước tại [Cài đặt và tải xuống](/start/install.html).

## Các bản phát hành trước đây {#historical}

Mọi thẻ hiện được phát hành trong [github.com/faberlang/releases](https://github.com/faberlang/releases/releases), theo thứ tự mới nhất trước. Các thẻ **Faber** là CLI dành cho người dùng. Các thẻ **Radix** là các gói lưu trữ CLI trình biên dịch trước đây, phần lớn chỉ có cho macOS arm64.

_Ảnh chụp danh mục từ GitHub Releases API. 41 thẻ, được tạo lại cho trang này._

### `faber-v1.1.1` {#faber-v1-1-1}

**Faber CLI** · phát hành ngày 2026-07-17 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/faber-v1.1.1)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.75.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.74.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.70.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.69.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.68.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.67.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.66.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.65.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.64.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.63.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.62.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.61.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.60.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.59.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.58.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.57.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.56.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.55.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.54.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.53.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.52.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.51.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.50.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.49.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.48.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.47.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.46.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.45.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.44.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.43.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.42.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.41.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.40.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.39.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.38.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.37.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.36.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.35.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.34.0)
...
**Trình biên dịch Radix** · phát hành ngày 2026-07-16 · [bản phát hành trên GitHub](https://github.com/faberlang/releases/releases/tag/radix-v0.32.0)
...
## Nguồn chính thức {#source-of-truth}

Các tài sản nằm trong kho công khai [faberlang/releases](https://github.com/faberlang/releases). Khi phát hành thẻ mới, hãy tạo lại trang này bằng `generator/scripts/generate-releases-page.py`, rồi dựng lại trang web.
