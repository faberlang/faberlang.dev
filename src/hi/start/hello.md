...
ऊपर दिया गया प्रोग्राम कैनोनिकल लैटिन रीडर रेंडरिंग है। रीडर लोकेल समान अर्थ वाले प्रोग्राम को अलग-अलग कीवर्ड पैक के साथ रेंडर कर सकते हैं, जबकि ग्लिफ़ और आइडेंटिफ़ायर सुरक्षित रहते हैं। गैर-लैटिन पैकेज लिखने से पहले [रीडर लोकेल](/language/reader-locales.html) में पूरा प्रमाण देखें।
