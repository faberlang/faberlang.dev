...
अपने प्लेटफ़ॉर्म के लिए वर्तमान रिलीज़ (**1.6.0**) [इंस्टॉल पेज](/start/install.html) से डाउनलोड करें,
आर्काइव का चेकसम सत्यापित करें, और आर्काइव के `bin/` और `share/` ट्री से `bin/faber` को अपने
`PATH` में रखें (दोनों ट्री को साथ रखें ताकि रीडर पैक रिज़ॉल्व हो सकें)। पुष्टि करें:
...
| चरण | पेज | परिणाम |
|---|---|---|
| 1 | [इंस्टॉल और डाउनलोड](/start/install.html) | Faber 1.6.0 को `PATH` में रखें और सत्यापित करें |
