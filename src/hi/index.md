...
इन्वेंटरी: [रिलीज़](/reference/releases.html)।
...
[रीडर लोकेल](/language/reader-locales.html) देखें।
...
- **संरचनात्मक ग्लिफ़** — मान प्रवाह और प्रकार-संधियाँ: `←` (बाइंड),
  `→` (रिटर्न प्रकार), `∴` (समापन संधि), `≡` (समानता), `∪` (यूनियन)।
...
| अनुभाग | विवरण |
|---|---|
| [इतिहास](/reference/design.html) | विकास-समयरेखा, प्रभाव और रिलीज़ इतिहास |
| [रिलीज़](/reference/releases.html) | नवीनतम Faber डाउनलोड तथा प्रकाशित प्रत्येक टैग और बाइनरी |
| [विशेषताएँ](/language/) | रीडर लोकेल, संकलन लेन, लैटिन शब्दावली, ग्लिफ़ प्रणाली, डिज़ाइन सिद्धांत |
| [सिंटैक्स](/language/) | पूर्ण संदर्भ: प्रकार, फ़ंक्शन, नियंत्रण प्रवाह, त्रुटियाँ, जेनरिक, संग्रह |
| [टूलिंग](/toolchain/) | Radix कंपाइलर पाइपलाइन, Faber CLI, कोडजेन लक्ष्य, स्क्रिप्टिंग |
| [इकोसिस्टम](/libraries/) | Norma, Cista, Triga, coreutils, AI Workbench, corpus |
| [Corpus](/corpus/) | सार्वजनिक corpus से जनरेट किए गए कीवर्ड और कंस्ट्रक्ट पृष्ठ |
| [संदर्भ](/reference/) | EBNF व्याकरण, डिज़ाइन दस्तावेज़, रिपॉज़िटरी |
...
पूरी चर्चा के लिए [रीडर लोकेल](/language/reader-locales.html) दस्तावेज़ देखें।
