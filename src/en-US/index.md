...
## Download Faber 1.3.0 {#download}

Current release: **Faber 1.3.0** (tag `faber-v1.3.0`). Prebuilt CLI archives
for macOS and Linux; extract the `faber-v1.3.0-<target-triple>/faber` binary
and put it on your `PATH`.

| Platform | Archive | Checksum |
|---|---|---|
| **macOS arm64** (Apple Silicon) | [faber-v1.3.0-aarch64-apple-darwin.tar.gz](https://github.com/faberlang/releases/releases/download/faber-v1.3.0/faber-v1.3.0-aarch64-apple-darwin.tar.gz) | [sha256](https://github.com/faberlang/releases/releases/download/faber-v1.3.0/faber-v1.3.0-aarch64-apple-darwin.tar.gz.sha256) |
| **Linux x64** (glibc) | [faber-v1.3.0-x86_64-unknown-linux-gnu.tar.gz](https://github.com/faberlang/releases/releases/download/faber-v1.3.0/faber-v1.3.0-x86_64-unknown-linux-gnu.tar.gz) | [sha256](https://github.com/faberlang/releases/releases/download/faber-v1.3.0/faber-v1.3.0-x86_64-unknown-linux-gnu.tar.gz.sha256) |
